...
`evals/corpus/v1/manifest.json` contains 32 independently labelled synthetic
L0 cases across 13 current risk classes. Most risks retain one positive/safe
...
cross-model blind AI second opinion, not human expert review. Rounds 31–32
added three new pairs (VR-PROMPT-008 untrusted-input trust-boundary,
VR-SKILL-014 sensitive host-path access, VR-PROMPT-010 dangling section
reference) as `provisional_single_review`; they are intentionally excluded
